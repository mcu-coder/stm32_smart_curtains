...
void W_Test(void)
{
  ...
  System_WriteInteriorFlash(addrShort1, (uint8_t *)&Data_init.Device_State, sizeof(Data_init.Device_State)); // 存入数据，函数内自动解锁，擦除，写入
	System_WriteInteriorFlash(addrShort2, (uint8_t *)&device_state_init.check_device, sizeof(device_state_init.check_device)); // 存入数据，函数内自动解锁，擦除，写入
...
void R_Test(void)
{
  ...
  System_ReadInteriorFlash(addrShort1, (uint8_t *)&Data_init.Device_State, sizeof(Data_init.Device_State)); // 读取数据，函数内自动按半字读取
	System_ReadInteriorFlash(addrShort2, (uint8_t *)&device_state_init.check_device, sizeof(device_state_init.check_device)); // 读取数据，函数内自动按半字读取
